...
- 2026-07-30 — Notifications overhaul: user-chosen delivery time (e.g. 6pm local), per-timezone scheduling, and new reminder types beyond the existing manual-bill/auto-pay/lodge-payment set (e.g. payday "log your pay") — notifications/cron/settings — status: pending
