...
a historical record only, not read at session start. Open it by hand if you need old investigation
detail that isn't preserved anywhere else (git history and closed GitHub issues cover the rest).
